...
RUN wget https://archive.apache.org/dist/tomcat/tomcat-9/v9.0.88/bin/apache-tomcat-9.0.88.tar.gz -P /tmp && \
    tar xf /tmp/apache-tomcat-9.0.88.tar.gz -C /opt && ln -s /opt/apache-tomcat-9.0.88 /opt/tomcat && \
